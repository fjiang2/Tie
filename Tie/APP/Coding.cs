...
namespace Tie
{
    ...
    public partial class Script
    {
        ...
        //这里的string function 是完整的Tie函数定义,如: "function(a,b) { return a+b;}" 
        /// <summary>
        ...
        {
            memory.Add(InternalConst.THIS, VAL.Boxing1(instance));

            if (code.IndexOf("return") == -1)
                return Script.Evaluate(InternalConst.THIS, code, memory, null);
            else
                return Script.Execute(InternalConst.THIS, code, memory, null);
        }

        ...
        private static bool parseArgument(string args, out string[] result)
        {
            ...
            while (k < args.Length)
            {
                ...
                else if (args[k] == '"')    //quotation mark argument
                {
                    ...
                    if (k == args.Length)
                    {
                        Console.Error.WriteLine("Unclosed quotation mark after the character string \"");
                        result = new string[] { };
                        return false;
                    }
        ...
        private bool eval(string args, out string result)
        {
            ...
            while (k < args.Length)
            {
                ...
                else if (args[k] == '{')
                {
                    ...
                    if (k == args.Length)
                    {
                        Console.Error.WriteLine("Unclosed expression character }");
                        result = string.Empty;
                        return false;
                    }
                    ...
                    else
                    {
                        ...
                        {
                            Console.Error.WriteLine($"error in {code}, {ex.Message}");
                        }
